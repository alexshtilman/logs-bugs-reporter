...
class OpenningLogsBugsTest {
	...
	void testNonExistingArtifact() {
		...
		testNewBugExists(logDto, BugStatus.OPEND, Seriousness.CRITICAL, null);
	}
	...
	void testExistingArtifactBlocking() {
		...
		testNewBugExists(logDto, BugStatus.ASSIGNED, Seriousness.BLOCKING, 4L);
	}
	...
	void testExistingArtifactCriticalAuthorization() {
		...
		testNewBugExists(logDto, BugStatus.ASSIGNED, Seriousness.CRITICAL, 2L);
	}
	...
	void testNullDate() {
		...
		testNewBugExists(logDto, BugStatus.ASSIGNED, Seriousness.MINOR, 4L);
	}
	...
	void testNullDateLogTypeEmptyArtifact() {
		...
		testNewBugExists(logDto, BugStatus.OPEND, Seriousness.MINOR, null);
	}

	public void testNewBugExists(LogDto logDto, BugStatus bugstatus, Seriousness seriosness, Long id) {
